...
public class NetworkHudCanvases : MonoBehaviour
{
    ...
    /// 
    [SerializeField]
    private Button _connectArduinoButton;
    [SerializeField]
    private Button _wallArduinoButton;
    [SerializeField]
    ...
    private void Start()
    {
        ...
        _connectArduinoButton.gameObject.SetActive(false);
        _wallArduinoButton.gameObject.SetActive(false);
    ...
    public void OnClick_Client()
    {
        ...
        if (_clientState != LocalConnectionState.Stopped)
            ...
            _connectArduinoButton.gameObject.SetActive(true);
            _wallArduinoButton.gameObject.SetActive(true);
